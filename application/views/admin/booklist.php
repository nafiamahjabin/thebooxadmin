          ...
          <div class="table-responsive">
            ...
            <tbody>
             <?php $i=1;foreach($bookslist as $vid){ ?>
              ...
              <td><a href="<?php echo base_url()?>index.php/admin/editbook?b_id=<?php echo $vid->b_id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $vid->b_id; ?>','e_book')">Delete</a></td>
            </tr>
            <?php $i++;} ?>
